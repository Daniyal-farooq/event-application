...
const events = () => {
  ...
  return (
    ...
    <input type="text" className={styles.in}  onChange={(e) => { setId(e.target.value) }} placeholder="Unique ID" name="id"/>
    <input type="text" className={styles.in} onChange={(e) => { setTitle(e.target.value) }} placeholder="Title" name="text"/> 
    <input type="date" className={styles.in} onChange={(e) => { setDate(e.target.value) }} placeholder="Date" name="date"/> 
    <input type="time" className={styles.in} onChange={(e) => { setTime(e.target.value) }} placeholder="Time" name="time"/> 
    <input type="text" className={styles.in} onChange={(e) => { setLocation(e.target.value) }} placeholder="location" name="location"/>
    <input type="text" className={styles.in} onChange={(e) => { setDescription(e.target.value) }} placeholder="description" name="descriprtion"/>
    <button  onClick={eventsubmithandler} className={styles.b}><p className={styles.t}>Submit</p></button>
    </form>
    </div> */}
